...
gray_scale_transform_test = Image(lena.data, ColorModel.rgb)
gray_scale_transform_test.to_gray().show_img()

sepia1 = gray_scale_transform_test.to_sepia((1.1, 0.9))
sepia2 = gray_scale_transform_test.to_sepia((1.5, 0.5))
sepia3 = gray_scale_transform_test.to_sepia((1.9, 0.1))
sepia4 = gray_scale_transform_test.to_sepia((), 20)
sepia5 = gray_scale_transform_test.to_sepia((), 30)
sepia6 = gray_scale_transform_test.to_sepia((), 40)
sepia1.show_img()
sepia2.show_img()
sepia3.show_img()
sepia4.show_img()
